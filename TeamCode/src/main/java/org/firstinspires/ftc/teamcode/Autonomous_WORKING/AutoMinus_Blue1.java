...
public class AutoMinus_Blue1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        armMotor1 = hardwareMap.get(DcMotor.class, "expansion_motor1");
        armMotor2 = hardwareMap.get(DcMotor.class, "expansion_motor2");
        ...
        armMotor2.setMode(DcMotor.RunMode.RUN_TO_POSITION);        //initializing the IMU and setting the units needed
        ...
        while (opModeIsActive()) {
            ...
            sleep(250);
            turn(-35);
            encoderMovement(80, 4, 0.5);
            sleep(1000);
            encoderMovement(30, 2, 0.2);
            sleep(250);
            carouselFunc();
            sleep(250);
    ...
    public void encoderMovement(double distance, int direction, double power) {
        ...
        switch (direction) {
            ...
            case 4: // robot will strafe right
                setTargetPositionCounts( ticks, 1.4 * -ticks,  -ticks, 1.1 * ticks);
                setMotorPowers(power,power+0.2,power,power+0.1);
                break;
